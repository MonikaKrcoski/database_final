...
QUERY1="""
select Owner_Code from VESSEL where Owner_Code!='NULL' group by Owner_Code having count(Owner_Code) >= 2 ;
"""
...
QUERY2="""
select CLIENT.Name, VESSEL.IMO, VESSEL.Name from CLIENT, VESSEL where VESSEL.Tonnage > 3000 and VESSEL.Owner_Code=CLIENT.Code in
(select Owner_Code from VESSEL where Owner_Code!='NULL' group by Owner_Code having count(Owner_Code) >= 2) order by CLIENT.Name, VESSEL.IMO ;
"""
...
# )
QUERY3="""
select count(*) from (select Owner_Code as Code from VESSEL where Owner_Code!='NULL' group by Owner_Code having count(Owner_Code) >= 2)
clt1, VESSEL where VESSEL.Owner_Code=clt1.Code and VESSEL.Tonnage > 3000 ;'
"""
...
QUERY4="""
select IMO from VESSEL where VESSEL.IMO not in (select * from VESSEL, VOYAGE where VOYAGE.Vessel_IMO=VESSEL.IMO) ;
"""
